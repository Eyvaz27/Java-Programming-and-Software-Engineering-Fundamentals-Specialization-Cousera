...
function setWidth (value) {
    if(isNumeric(value)){
        ...
        alert("Entered Width parameter is wrong");
    }
}
...
function setHeight (value) {
    if(isNumeric(value)){
        ...
        alert("Entered Height parameter is wrong");
    }
}
...
function isNumeric(value) {
    // standard JavaScript function to determine 
    // whether a string is an illegal number (Not-a-Number) 
    return !isNaN(value);
}
